...
_COMMANDS = (
    ...
    Command("download_library", "4", "show_download_library", "Downloaded", "Browse verified downloads"),
    Command("build_matrix", "5", "show_build_matrix", "Build", "Show build view"),
    Command("builds", "6", "show_builds", "Builds", "Show build history"),
    Command("patches", "7", "show_patches", "Patches", "List compatible patches"),
    Command("cache", "8", "show_cache", "Cache", "Show cache controls"),
